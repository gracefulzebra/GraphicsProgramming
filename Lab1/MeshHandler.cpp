...
void MeshHandler::InitializeMesh(Vertex* vertices, unsigned int numVertices, unsigned int* indices, unsigned int numIndices)
{
	IndexedModel model;
...
void MeshHandler::LoadModelFromFile(const std::string& filename)
{
	IndexedModel model = OBJModel(filename).ToIndexedModel();
	InitializeModel(model);
}

void MeshHandler::InitializeModel(const IndexedModel& model)
{
